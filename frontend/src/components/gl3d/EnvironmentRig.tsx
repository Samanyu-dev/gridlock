 ...
 * the network cost. */
export function EnvironmentRig({ background = '#05060a', shadows = true, transparent = false }: { background?: string; shadows?: boolean; transparent?: boolean }) {
  ...
  return (
    <>
      ...
      {!transparent && <mesh rotation={[-Math.PI / 2, 0, 0]} position={[0, -0.025, 0]} receiveShadow>
