...
const CIRCUITS = [
  ...
  { src: `${SRC_DIR}/albert-park.geojson`, id: 'circuit.albert-park', slug: 'albert-park', country: 'AU', cornerAngleDeg: 9 },
  { src: `${SRC_DIR}/shanghai.geojson`, id: 'circuit.shanghai', slug: 'shanghai', country: 'CN', cornerAngleDeg: 9 },
  { src: `${SRC_DIR}/suzuka.geojson`, id: 'circuit.suzuka', slug: 'suzuka', country: 'JP', cornerAngleDeg: 9 },
  { src: `${SRC_DIR}/bahrain.geojson`, id: 'circuit.bahrain', slug: 'bahrain', country: 'BH', cornerAngleDeg: 9 },
  { src: `${SRC_DIR}/jeddah.geojson`, id: 'circuit.jeddah', slug: 'jeddah', country: 'SA', cornerAngleDeg: 9 },
  { src: `${SRC_DIR}/miami.geojson`, id: 'circuit.miami', slug: 'miami', country: 'US', cornerAngleDeg: 9 },
  { src: `${SRC_DIR}/imola.geojson`, id: 'circuit.imola', slug: 'imola', country: 'IT', cornerAngleDeg: 9 },
  { src: `${SRC_DIR}/barcelona.geojson`, id: 'circuit.barcelona-catalunya', slug: 'barcelona-catalunya', country: 'ES', cornerAngleDeg: 9 },
  { src: `${SRC_DIR}/gilles-villeneuve.geojson`, id: 'circuit.gilles-villeneuve', slug: 'gilles-villeneuve', country: 'CA', cornerAngleDeg: 9 },
  { src: `${SRC_DIR}/red-bull-ring.geojson`, id: 'circuit.red-bull-ring', slug: 'red-bull-ring', country: 'AT', cornerAngleDeg: 9 },
  { src: `${SRC_DIR}/hungaroring.geojson`, id: 'circuit.hungaroring', slug: 'hungaroring', country: 'HU', cornerAngleDeg: 9 },
  { src: `${SRC_DIR}/zandvoort.geojson`, id: 'circuit.zandvoort', slug: 'zandvoort', country: 'NL', cornerAngleDeg: 9 },
  { src: `${SRC_DIR}/monza.geojson`, id: 'circuit.monza', slug: 'monza', country: 'IT', cornerAngleDeg: 9 },
  { src: `${SRC_DIR}/baku.geojson`, id: 'circuit.baku', slug: 'baku', country: 'AZ', cornerAngleDeg: 9 },
  { src: `${SRC_DIR}/marina-bay.geojson`, id: 'circuit.marina-bay', slug: 'marina-bay', country: 'SG', cornerAngleDeg: 9 },
  { src: `${SRC_DIR}/cota.geojson`, id: 'circuit.cota', slug: 'cota', country: 'US', cornerAngleDeg: 9 },
  { src: `${SRC_DIR}/mexico-city.geojson`, id: 'circuit.mexico-city', slug: 'mexico-city', country: 'MX', cornerAngleDeg: 9 },
  { src: `${SRC_DIR}/interlagos.geojson`, id: 'circuit.interlagos', slug: 'interlagos', country: 'BR', cornerAngleDeg: 9 },
  { src: `${SRC_DIR}/las-vegas.geojson`, id: 'circuit.las-vegas', slug: 'las-vegas', country: 'US', cornerAngleDeg: 9 },
  { src: `${SRC_DIR}/lusail.geojson`, id: 'circuit.lusail', slug: 'lusail', country: 'QA', cornerAngleDeg: 9 },
  { src: `${SRC_DIR}/yas-marina.geojson`, id: 'circuit.yas-marina', slug: 'yas-marina', country: 'AE', cornerAngleDeg: 9 },
]
